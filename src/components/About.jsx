...
export default function About() {
  return (
    <section id="about" className="py-24 relative section-gradient-dark overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-center">
          <AnimatedSection animation="fadeLeft">
            <div className="flex flex-col md:flex-row gap-8 mb-8">
              <div className="relative flex-shrink-0">
                <div className="w-40 h-40 rounded-2xl overflow-hidden border-4 border-white/5" style={{ boxShadow: '0 0 28px rgba(37,99,235,0.09)' }}>
                  <img 
                    src="/profile.jpeg" 
                    alt="Ahmad Irshaid" 
                ...
                <div className="absolute -inset-2 bg-[rgba(37,99,235,0.06)] blur-xl rounded-2xl -z-10" />
              </div>
              <div>
          ...
          <StaggerChildren className="grid grid-cols-2 gap-6">
            {[
              ...
              <TiltCard key={i} className="glass rounded-2xl p-8 text-center hover:glow transition-all duration-300 border border-white/5">
