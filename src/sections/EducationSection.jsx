...
export default function EducationSection() {
  ...
  return (
    <section id="education" className="py-16 relative section-gradient-light overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {education.map((edu, index) => (
            <div key={index} className="glass rounded-xl p-5 hover:border-[var(--accent-icon)] transition-all border border-white/5">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-lg bg-[rgba(37,99,235,0.08)] border flex items-center justify-center" style={{borderColor: 'rgba(255,255,255,0.06)'}}>
